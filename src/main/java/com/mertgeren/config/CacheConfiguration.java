...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("SpringBootRestApiAngular");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("SpringBootRestApiAngular");
        ...
        config.getMapConfigs().put("com.mertgeren.domain.*", initializeDomainMapConfig(jHipsterProperties));
